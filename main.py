...
class main:
    ...
    def __init__(self, root):
        ...
        bt_setting = tk.Button(relief = "flat", bd = 1, activebackground = bg_colour, activeforeground = "black", bg = bg_colour, fg = "black", height = 1, width = 15, font = ("malgun gothic", 11, "underline"), text = "Setting", command = lambda: self.new_window(setting))
        global entry
